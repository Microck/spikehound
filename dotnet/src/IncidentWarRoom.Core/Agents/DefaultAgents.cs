...
namespace IncidentWarRoom.Core.Agents;

public static class CloudGate
{
    public static bool IsEnabled() =>
        string.Equals(Environment.GetEnvironmentVariable("INCIDENT_WR_CLOUD_ENABLED"), "true", StringComparison.OrdinalIgnoreCase);
}
    ...
    public Task<AgentResult<InvestigationFindings>> RunAsync(JsonElement input, CancellationToken cancellationToken)
    {
        ...
        var findings = new InvestigationFindings(
            ...
            Notes: CloudGate.IsEnabled()
                ...
                : "Cloud calls disabled (set INCIDENT_WR_CLOUD_ENABLED=true to enable)."
        );
